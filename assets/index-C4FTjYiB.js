...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Ia(){return new gt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Zs(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Na(){return new gt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Zs(),fragmentShader:`
...
`)+`
`+u);const T=A+p+a,E=A+u+o,U=Ga(r,r.VERTEX_SHADER,T),L=Ga(r,r.FRAGMENT_SHADER,E);r.attachShader(M,U),r.attachShader(M,L),t.index0AttributeName!==void 0?r.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function w(C){if(i.debug.checkShaderErrors){const G=r.getProgramInfoLog(M).trim(),z=r.getShaderInfoLog(U).trim(),K=r.getShaderInfoLog(L).trim();let Z=!0,X=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,M,U,L);else{const j=Xa(r,U,"vertex"),H=Xa(r,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
}`;class dt{constructor(e,t){Q(this,"sceneWidth");Q(this,"sceneHeight");Q(this,"renderer");Q(this,"camera");Q(this,"pointLights");Q(this,"pointLightsTHREE");Q(this,"infiniteLights");Q(this,"infiniteLightsTHREE");Q(this,"skyLight");Q(this,"skyLightDirections");Q(this,"lightingMaterial");Q(this,"injectionMaterial");Q(this,"advectionMaterial");Q(this,"divergenceMaterial");Q(this,"pressureMaterial");Q(this,"projectionMaterial");Q(this,"compositeMaterial");Q(this,"backgroundTarget");Q(this,"gBuffer");Q(this,"lightingTarget");Q(this,"hydraulicsTarget");Q(this,"injectionTarget");Q(this,"advectionTarget");Q(this,"divergenceTarget");Q(this,"pressureTargetA");Q(this,"pressureTargetB");Q(this,"projectionTarget");Q(this,"compositeTarget");Q(this,"backgroundScene");Q(this,"terrainScene");Q(this,"lightingScene");Q(this,"hydraulicsScene");Q(this,"injectionScene");Q(this,"advectionScene");Q(this,"divergenceScene");Q(this,"pressureScene");Q(this,"projectionScene");Q(this,"compositeScene");Q(this,"screenScene");this.sceneWidth=e,this.sceneHeight=t,this.renderer=new ap({antialias:!1,preserveDrawingBuffer:!0}),this.renderer.autoClear=!1,this.renderer.setSize(e,t),this.renderer.toneMapping=pn,console.log(this.renderer.capabilities);const n=this.renderer.capabilities.isWebGL2;console.log("Running WebGL version:",n?"WebGL2":"WebGL1"),console.log(this.renderer.extensions.get("EXT_color_buffer_float")),document.body.appendChild(this.renderer.domElement),this.camera=new Co(-this.sceneWidth/2,this.sceneWidth/2,this.sceneHeight/2,-this.sceneHeight/2,0,1e3),this.backgroundTarget=this.createFloatMRT(e,t,1),this.gBuffer=this.createFloatMRT(e,t,7),this.lightingTarget=this.createFloatMRT(e,t,1),this.hydraulicsTarget=this.createFloatMRT(e,t,2),this.injectionTarget=this.createFloatMRT(e,t,3),this.advectionTarget=this.createFloatMRT(e,t,2),this.divergenceTarget=this.createFloatMRT(e,t,1),this.pressureTargetA=this.createFloatMRT(e,t,1),this.pressureTargetB=this.createFloatMRT(e,t,1),this.projectionTarget=this.createFloatMRT(e,t,2),this.compositeTarget=this.createFloatMRT(e,t,1),this.backgroundScene=new Xt,this.terrainScene=new Xt,this.lightingScene=new Xt,this.hydraulicsScene=new Xt,this.injectionScene=new Xt,this.advectionScene=new Xt,this.divergenceScene=new Xt,this.pressureScene=new Xt,this.projectionScene=new Xt,this.compositeScene=new Xt,this.screenScene=new Xt,this.pointLights=un.getPointLights(),console.log(this.pointLights),this.pointLightsTHREE=dt.convertPointLights(this.pointLights),dt.padPointLights(this.pointLightsTHREE),this.infiniteLights=un.getInfiniteLights(),this.infiniteLightsTHREE=dt.convertInfiniteLights(this.infiniteLights),dt.padInfiniteLights(this.infiniteLightsTHREE),this.skyLight=un.getSkyLight(),this.skyLightDirections=op.generateSkySamples(100);const r={screenWidth:{value:e},screenHeight:{value:t},albedoMap:{value:this.gBuffer.textures[0]},normalMap:{value:this.gBuffer.textures[1]},heightMap:{value:this.gBuffer.textures[2]},specularMap:{value:this.gBuffer.textures[3]},shininessMap:{value:this.gBuffer.textures[4]},pointLights:{value:this.pointLightsTHREE},numPointLightsInUse:{value:this.pointLights.length},skyLight:{value:dt.convertSkyLight(this.skyLight)},skyLightDirections:{value:this.skyLightDirections},infiniteLights:{value:this.infiniteLightsTHREE},numInfiniteLightsInUse:{value:this.infiniteLights.length}};this.lightingMaterial=new gt({uniforms:r,glslVersion:Bt,vertexShader:$t,fragmentShader:cp});const s=new ut(new bt(e,t),this.lightingMaterial);this.lightingScene.add(s);const a={screenWidth:{value:e},screenHeight:{value:t},hydraulicsMap:{value:this.hydraulicsTarget.textures[0]},emissionsMap:{value:this.hydraulicsTarget.textures[1]},velocityMap:{value:this.projectionTarget.textures[0]},matterMap:{value:this.projectionTarget.textures[1]}};this.injectionMaterial=new gt({uniforms:a,glslVersion:Bt,vertexShader:$t,fragmentShader:hp});const o=new ut(new bt(e,t),this.injectionMaterial);this.injectionScene.add(o);const l={screenWidth:{value:e},screenHeight:{value:t},hydraulicsMap:{value:this.hydraulicsTarget.textures[0]},velocityMap:{value:this.injectionTarget.textures[0]},matterMap:{value:this.injectionTarget.textures[1]}};this.advectionMaterial=new gt({uniforms:l,glslVersion:Bt,vertexShader:$t,fragmentShader:dp});const c=new ut(new bt(e,t),this.advectionMaterial);this.advectionScene.add(c);const h={screenWidth:{value:e},screenHeight:{value:t},hydraulicsMap:{value:this.hydraulicsTarget.textures[0]},velocityMap:{value:this.advectionTarget.textures[0]},matterMap:{value:this.advectionTarget.textures[1]}};this.divergenceMaterial=new gt({uniforms:h,glslVersion:Bt,vertexShader:$t,fragmentShader:fp});const d=new ut(new bt(e,t),this.divergenceMaterial);this.divergenceScene.add(d);const f={screenWidth:{value:e},screenHeight:{value:t},hydraulicsMap:{value:this.hydraulicsTarget.textures[0]},divergenceMap:{value:this.divergenceTarget.texture},pressureMap:{value:this.pressureTargetB.texture}};this.pressureMaterial=new gt({uniforms:f,glslVersion:Bt,vertexShader:$t,fragmentShader:pp});const m=new ut(new bt(e,t),this.pressureMaterial);this.pressureScene.add(m);const v={screenWidth:{value:e},screenHeight:{value:t},hydraulicsMap:{value:this.hydraulicsTarget.textures[0]},velocityMap:{value:this.advectionTarget.textures[0]},matterMap:{value:this.advectionTarget.textures[1]},pressureMap:{value:this.pressureTargetA.texture},divergenceMap:{value:this.divergenceTarget.texture}};this.projectionMaterial=new gt({uniforms:v,glslVersion:Bt,vertexShader:$t,fragmentShader:mp});const M=new ut(new bt(e,t),this.projectionMaterial);this.projectionScene.add(M);const p={screenWidth:{value:e},screenHeight:{value:t},heightMap:{value:this.gBuffer.textures[2]},backgroundMap:{value:this.backgroundTarget.texture},foregroundMap:{value:this.lightingTarget.texture},hydraulicsMap:{value:this.hydraulicsTarget.textures[0]},initialVelocityMap:{value:this.injectionTarget.textures[2]},injectedVelocityMap:{value:this.injectionTarget.textures[0]},advectedVelocityMap:{value:this.advectionTarget.textures[0]},projectedVelocityMap:{value:this.projectionTarget.textures[0]},matterMap:{value:this.projectionTarget.textures[1]},divergenceMap:{value:this.divergenceTarget.texture},pressureMapA:{value:this.pressureTargetA.texture},pressureMapB:{value:this.pressureTargetB.texture},pointLights:{value:this.pointLightsTHREE},numPointLightsInUse:{value:this.pointLights.length},infiniteLights:{value:this.infiniteLightsTHREE},numInfiniteLightsInUse:{value:this.infiniteLights.length}};this.compositeMaterial=new gt({uniforms:p,glslVersion:Bt,vertexShader:$t,fragmentShader:gp});const u=new ut(new bt(e,t),this.compositeMaterial);this.compositeScene.add(u);const A=new Ys({map:Object.assign(this.compositeTarget.texture,{minFilter:vt,magFilter:vt})}),T=new ut(new bt(e,t),A);this.screenScene.add(T)}async displayPrompt(){const e=await yt.loadTexture("./assets/textures/wasd_prompt.png");this.projectionMaterial.uniforms.matterMap.value=e,this.renderer.setRenderTarget(this.projectionTarget),this.renderer.render(this.projectionScene,this.camera),this.projectionMaterial.uniforms.matterMap.value=this.advectionTarget.textures[1],console.log("PROMPT"),console.log("FFFFFFFFFFFUUUUUUUUUUUUCCCCCCCCKKKKKKKKKK")}render(){this.renderer.setRenderTarget(this.backgroundTarget),this.renderer.render(this.backgroundScene,this.camera),this.renderer.setRenderTarget(this.gBuffer),this.renderer.clearDepth(),this.renderer.render(this.terrainScene,this.camera),this.pointLights=un.getPointLights(),this.pointLightsTHREE=dt.convertPointLights(this.pointLights),dt.padPointLights(this.pointLightsTHREE),this.lightingMaterial.uniforms.pointLights.value=this.pointLightsTHREE,this.lightingMaterial.uniforms.numPointLightsInUse.value=this.pointLights.length,this.lightingMaterial.uniforms.skyLight.value=dt.convertSkyLight(this.skyLight),this.infiniteLights=un.getInfiniteLights(),this.infiniteLightsTHREE=dt.convertInfiniteLights(this.infiniteLights),dt.padInfiniteLights(this.infiniteLightsTHREE),this.lightingMaterial.uniforms.infiniteLights.value=this.infiniteLightsTHREE,this.lightingMaterial.uniforms.numInfiniteLightsInUse.value=this.infiniteLights.length,this.renderer.setRenderTarget(this.lightingTarget),this.renderer.render(this.lightingScene,this.camera),this.renderer.setRenderTarget(this.hydraulicsTarget),this.renderer.clear(),this.renderer.render(this.hydraulicsScene,this.camera),this.renderer.setRenderTarget(this.injectionTarget),this.renderer.render(this.injectionScene,this.camera),this.renderer.setRenderTarget(this.advectionTarget),this.renderer.render(this.advectionScene,this.camera),this.renderer.setRenderTarget(this.divergenceTarget),this.renderer.render(this.divergenceScene,this.camera),this.renderer.setRenderTarget(this.pressureTargetA),this.renderer.clear(),this.renderer.setRenderTarget(this.pressureTargetB),this.renderer.clear(),this.renderer.setRenderTarget(this.pressureTargetA),this.renderer.render(this.pressureScene,this.camera);const e=25;for(let t=0;t<e;t++)this.pressureMaterial.uniforms.pressureMap.value=this.pressureTargetA.texture,this.renderer.setRenderTarget(this.pressureTargetB),this.renderer.render(this.pressureScene,this.camera),this.pressureMaterial.uniforms.pressureMap.value=this.pressureTargetB.texture,this.renderer.setRenderTarget(this.pressureTargetA),this.renderer.render(this.pressureScene,this.camera);this.renderer.setRenderTarget(this.projectionTarget),this.renderer.render(this.projectionScene,this.camera),this.divergenceMaterial.uniforms.velocityMap.value=this.projectionTarget.textures[0],this.renderer.setRenderTarget(this.divergenceTarget),this.renderer.render(this.divergenceScene,this.camera),this.compositeMaterial.uniforms.pointLights.value=this.pointLightsTHREE,this.compositeMaterial.uniforms.numPointLightsInUse.value=this.pointLights.length,this.compositeMaterial.uniforms.infiniteLights.value=this.infiniteLightsTHREE,this.compositeMaterial.uniforms.numInfiniteLightsInUse.value=this.infiniteLights.length,this.renderer.setRenderTarget(this.compositeTarget),this.renderer.render(this.compositeScene,this.camera),this.renderer.setRenderTarget(null),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.render(this.screenScene,this.camera)}async createSolidMesh(e,t){const n="./assets/textures/",r=await yt.loadWithFallback(`${n}${e}_albedo.png`),s=await yt.loadWithFallback(`${n}${e}_normal.png`),a=await yt.loadWithFallback(`${n}${e}_height.png`),o=await yt.loadWithFallback(`${n}${e}_specular.png`),l=await yt.loadWithFallback(`${n}${e}_shininess.png`),c=await yt.loadWithFallback(`${n}${e}_hydraulics.png`),h=await yt.loadWithFallback(`${n}${e}_emissions.png`),d=new bt(r.image.width,r.image.height),f=new gt({uniforms:{heightScaling:{value:t},albedoMap:{value:r},normalMap:{value:s},heightMap:{value:a},specularMap:{value:o},shininessMap:{value:l},hydraulicsMap:{value:c},emissionsMap:{value:h}},glslVersion:Bt,vertexShader:$t,fragmentShader:lp});return new ut(d,f)}async createFluidMesh(e){const t="./assets/textures/",n=await yt.loadWithFallback(`${t}${e}_albedo.png`),r=await yt.loadWithFallback(`${t}${e}_hydraulics.png`),s=await yt.loadWithFallback(`${t}${e}_emissions.png`),a=Math.max(n.image.width,r.image.width),o=Math.max(n.image.height,r.image.height),l=new bt(a,o),c=new gt({uniforms:{screenWidth:{value:this.sceneWidth},screenHeight:{value:this.sceneHeight},albedoMap:{value:n},heightMap:{value:this.gBuffer.textures[2]},hydraulicsMap:{value:r},emissionsMap:{value:s},velocityMap:{value:this.projectionTarget.textures[0]}},glslVersion:Bt,vertexShader:$t,fragmentShader:up});return new ut(l,c)}async createSimpleMesh(e){const t="./assets/textures/",n=await yt.loadTexture(`${t}${e}_albedo.png`),r=await yt.loadTexture(`${t}${e}_normal.png`),s=new bt(n.image.width,n.image.height),a=new gt({uniforms:{albedoMap:{value:n},normalMap:{value:r}},glslVersion:Bt,vertexShader:$t,fragmentShader:_p});return new ut(s,a)}async addEntities(e){Array.isArray(e)?await Promise.all(e.map(t=>this.addEntity(t))):await this.addEntity(e)}removeEntities(e){Array.isArray(e)?e.forEach(t=>{this.removeEntity(t)}):this.removeEntity(e)}async addEntity(e){e instanceof Li?(await e.initMesh(this),this.terrainScene.add(e.getSolidMesh()),this.hydraulicsScene.add(e.getFluidMesh())):e instanceof Qa&&(await e.initMesh(this),this.backgroundScene.add(e.getMesh()))}removeEntity(e){e instanceof Li?(e.getSolidMesh()&&this.terrainScene.remove(e.getSolidMesh()),e.getFluidMesh()&&this.hydraulicsScene.remove(e.getFluidMesh())):e instanceof Qa&&e.getMesh()&&this.backgroundScene.remove(e.getMesh())}static convertSimpleLights(e){return e.map(t=>({positionWorld:dt.convertToThreeVec3(t.positionWorld),color:dt.convertToThreeVec3(t.color),falloff:t.falloff,radius:t.radius}))}static padSimpleLights(e){const t={positionWorld:new F(0,0,0),color:new F(0,0,0),falloff:1,radius:0},n=100;for(;e.length<n;)e.push(t)}static convertPointLights(e){return e.map(t=>({positionWorld:dt.convertToThreeVec3(t.positionWorld),color:dt.convertToThreeVec3(t.color),falloff:t.falloff,radius:t.radius}))}static padPointLights(e){const t={positionWorld:new F(0,0,0),color:new F(0,0,0),falloff:1,radius:0},n=100;for(;e.length<n;)e.push(t)}static convertInfiniteLights(e){return e.map(t=>({direction:dt.convertToThreeVec3(t.direction),color:dt.convertToThreeVec3(t.color),shadowDistance:t.shadowDistance}))}static padInfiniteLights(e){const t={direction:new F(0,0,0),color:new F(0,0,0),shadowDistance:0},n=10;for(;e.length<n;)e.push(t)}static convertSkyLight(e){return{color:dt.convertToThreeVec3(e.color),shadowDistance:e.shadowDistance}}static convertToThreeVec3(e){return new F(e.x,e.y,e.z)}createFloatMRT(e,t,n){const r=new Cn(e,t,{type:Qt,minFilter:vt,magFilter:vt,count:n});for(let s=0;s<n;s++)r.textures[s].generateMipmaps=!1;return this.renderer.setRenderTarget(r),this.renderer.clear(),r}logTextureInfo(e){var t,n;console.log(`Size: ${(t=e.image)==null?void 0:t.width} x ${(n=e.image)==null?void 0:n.height}`),console.log("Type:",e.type),console.log("Format:",e.format),console.log("MinFilter:",e.minFilter),console.log("MagFilter:",e.magFilter),console.log("GenerateMipmaps:",e.generateMipmaps),console.log("WrapS:",e.wrapS),console.log("WrapT:",e.wrapT)}}async function vp(){const i=new qo;document.body.appendChild(i.dom);const e=320,t=176,n=new Yo;n.loadScene(new $o);const r=new dt(e,t);console.log(n.getAllEntities()),await r.displayPrompt(),await r.addEntities(n.getAllEntities());let s=performance.now();const o=1e3/100;function l(c){requestAnimationFrame(l);const h=c-s;h<o||(s=c,i.begin(),n.update(h/1e3),n.syncMeshState(),r.render(),i.end())}requestAnimationFrame(l)}vp();
